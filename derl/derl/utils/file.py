...
def load_pickle_from_string(string):
...
def id2path(id_, subfolder, base_dir=None, sweep_name=None, task_num=1):
    if "models" in subfolder:
        ext = "pt"
    elif "xml" in subfolder:
        ext = "xml"
    elif "metadata" in subfolder:
        ext = "json"
    elif subfolder == "unimal_init":
        ext = "pkl"
    elif "unimal_pkl" in subfolder:
        ext = "pkl"
    elif "rewards" in subfolder:
        ext = "json"
    elif subfolder == "images":
        ext = "jpg"
    elif subfolder.isdigit():
        ext = "xml"
