...
try:
    ...
    from derl.derl.yacs import CfgNode as CN
...
_C.BODY.MOTOR_GEAR_RANGE = [JOINT_GEAR_MIN, JOINT_GEAR_MAX, 1]
...
_C.TORSO.HEAD_RADIUS_RANGE = [0.10] #[HEAD_RADIUS_MIN, HEAD_RADIUS_MAX, 0.001]
...
_C.TORSO.DENSITY_RANGE = [HEAD_DENSITY_MIN, HEAD_DENSITY_MAX, 1]
...
_C.LIMB.RADIUS_RANGE = [0.05] #[LIMB_RADIUS_MIN, LIMB_RADIUS_MAX, 0.001]

_C.LIMB.HEIGHT_RANGE = [LIMB_HEIGHT_MIN, LIMB_HEIGHT_MAX, 0.001]

# Density of the limbs
_C.LIMB.DENSITY_RANGE = [LIMB_DENSITY_MIN, LIMB_DENSITY_MAX, 1]

# Number of limbs in the unimal. Limbs does not include the head. Range is
# inclusive.
_C.LIMB.NUM_LIMBS_RANGE = [3, 10, 1] #[3, 10, 1]

# Max number of allowed limbs. When this limit is reached mutation won't
# grow limbs
_C.LIMB.MAX_LIMBS = 10 #12
...
_C.OBJECT.GOAL_REACHED_THRESHOLD = 0.5

_C.OBJECT.GOAL_REACHED_BONUS = 2000.0

_C.OBJECT.WALL_HEIGHT = 2

_C.OBJECT.WALL_THICKNESS = 0.1
...
_C.EVO.IS_EVO = False #True

_C.EVO.IS_EVO_TASK = False
# Number of prallel searches per node
_C.EVO.NUM_PROCESSES = 128 #18

# Population size
_C.EVO.INIT_POPULATION_SIZE = 500000 #576

_C.EVO.INIT_METHOD = "limb_count_pop_init"

_C.EVO.IS_MUTATE = False

_C.EVO.NUM_MUTATION = 10

_C.EVO.MUTATE_TOP_K = 5
